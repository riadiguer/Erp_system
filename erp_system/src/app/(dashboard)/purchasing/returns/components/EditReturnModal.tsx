...
import { X, Plus, Check, Building, AlertTriangle, Package, RotateCcw, DollarSign, Edit } from 'lucide-react'
...
export default function EditReturnModal({ 
  ...
  // Initialiser le formulaire avec les données du retour
  useEffect(() => {
    if (retourFournisseur && isOpen) {
      setFormData({
        fournisseur: retourFournisseur.fournisseur,
        motifRetour: retourFournisseur.motifRetour,
        descriptionMotif: retourFournisseur.descriptionMotif,
        produits: retourFournisseur.produits,
        prixAchat: retourFournisseur.prixAchat,
        montantRetour: retourFournisseur.montantRetour,
        commentaires: retourFournisseur.commentaires,
        gestionnaire: retourFournisseur.gestionnaire,
        numeroCommande: retourFournisseur.numeroCommande || ''
      })
    }
  }, [retourFournisseur, isOpen])
      ...
      <div className="relative bg-white rounded-xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-orange-50 to-orange-100">
          <h3 className="text-xl font-semibold text-gray-900 flex items-center">
            ...
            <div>
              <div className="font-bold">Modifier le retour fournisseur</div>
              <div className="text-sm font-normal text-gray-600">
                {retourFournisseur.numeroRetour} • {retourFournisseur.statut}
              </div>
            </div>
          </h3>
          <button 
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Info du retour existant */}
          <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
            <div className="text-sm text-orange-800">
              <strong>Retour créé le :</strong> {new Date(retourFournisseur.dateRetour).toLocaleDateString('fr-FR')}
              <span className="mx-2">•</span>
              <strong>Montant actuel :</strong> {retourFournisseur.montantRetour.toLocaleString()} DT
              <span className="mx-2">•</span>
              <strong>Statut :</strong> {retourFournisseur.statut}
            </div>
          </div>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
              <h4 className="text-lg font-semibold text-gray-900 mb-3 flex items-center justify-between">
                <span className="flex items-center">
                  ...
                  Articles actuellement retournés ({formData.produits.length})
                </span>
                <span className="text-xl font-bold text-orange-700 flex items-center">
                  <DollarSign className="w-5 h-5 mr-1" />
                  {calculateMontants(formData.produits).montantRetour.toLocaleString()} DT
                </span>
              </h4>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-3">
              ...
              Ajouter d'autres produits à retourner
            </label>
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 resize-none"
              placeholder="Modifiez les commentaires si nécessaire..."
            />
            <div className="mt-1 text-xs text-gray-500">
              Informations complémentaires sur les modifications apportées
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between px-6 py-4 bg-gray-50 border-t border-gray-200 rounded-b-xl">
          <div className="text-sm text-gray-600">
            <span className="font-medium">Attention :</span> Les modifications seront appliquées au retour {retourFournisseur.numeroRetour}
          </div>
