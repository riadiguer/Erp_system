...
/* ======================================================
   🔸 Composant principal ProductForm
   ====================================================== */
...
export default function ProductForm({
  ...
  const validateField = (field: string) => {
    ...
    switch (field) {
      case "name":
        if (!form.name || !form.name.trim()) newErrors.name = "Le nom est obligatoire";
        else if (form.name.trim().length < 3)
          newErrors.name = "Le nom doit contenir au moins 3 caractères";
        else delete newErrors.name;
        break;
      case "sku":
        if (!form.sku || !form.sku.trim()) newErrors.sku = "La référence est obligatoire";
      ...
      case "stock_qty":
        if (form.track_stock) {
          ...
          else delete newErrors.stock_qty;
        }
        break;
      case "unit_price":
